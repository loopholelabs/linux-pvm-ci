...
build/fedora-experimental/baremetal: build/pre/fedora-experimental/baremetal
	cd work/fedora-experimental/baremetal/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-baremetal-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/baremetal
build/fedora-experimental/hetzner: build/pre/fedora-experimental/hetzner
	cd work/fedora-experimental/hetzner/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-hetzner-${COMMIT_SHORT}" rpm-pkg
...
build/fedora-experimental/digitalocean: build/pre/fedora-experimental/digitalocean
	cd work/fedora-experimental/digitalocean/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-digitalocean-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/digitalocean
build/fedora-experimental/aws: build/pre/fedora-experimental/aws
	cd work/fedora-experimental/aws/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-aws-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/aws
build/fedora-experimental/gcp: build/pre/fedora-experimental/gcp
	cd work/fedora-experimental/gcp/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-gcp-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/gcp
build/fedora-experimental/ovh: build/pre/fedora-experimental/ovh
	cd work/fedora-experimental/ovh/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-ovh-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/ovh
build/fedora-experimental/linode: build/pre/fedora-experimental/linode
	cd work/fedora-experimental/linode/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-fedora-experimental-linode-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/fedora-experimental/linode

build/rocky-experimental/baremetal: build/pre/rocky-experimental/baremetal
	cd work/rocky-experimental/baremetal/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-baremetal-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/baremetal
build/rocky-experimental/hetzner: build/pre/rocky-experimental/hetzner
	cd work/rocky-experimental/hetzner/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-hetzner-${COMMIT_SHORT}" rpm-pkg
...
build/rocky-experimental/digitalocean: build/pre/rocky-experimental/digitalocean
	cd work/rocky-experimental/digitalocean/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-digitalocean-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/digitalocean
build/rocky-experimental/aws: build/pre/rocky-experimental/aws
	cd work/rocky-experimental/aws/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-aws-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/aws
build/rocky-experimental/gcp: build/pre/rocky-experimental/gcp
	cd work/rocky-experimental/gcp/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-gcp-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/gcp
build/rocky-experimental/ovh: build/pre/rocky-experimental/ovh
	cd work/rocky-experimental/ovh/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-ovh-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/ovh
build/rocky-experimental/azure: build/pre/rocky-experimental/azure
	cd work/rocky-experimental/azure/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-azure-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/azure
build/rocky-experimental/civo: build/pre/rocky-experimental/civo
	cd work/rocky-experimental/civo/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-civo-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/civo
build/rocky-experimental/linode: build/pre/rocky-experimental/linode
	cd work/rocky-experimental/linode/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-rocky-experimental-linode-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/rocky-experimental/linode

build/alma-experimental/baremetal: build/pre/alma-experimental/baremetal
	cd work/alma-experimental/baremetal/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-baremetal-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/baremetal
build/alma-experimental/hetzner: build/pre/alma-experimental/hetzner
	cd work/alma-experimental/hetzner/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-hetzner-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/hetzner
build/alma-experimental/digitalocean: build/pre/alma-experimental/digitalocean
	cd work/alma-experimental/digitalocean/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-digitalocean-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/digitalocean
build/alma-experimental/aws: build/pre/alma-experimental/aws
	cd work/alma-experimental/aws/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-aws-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/aws
build/alma-experimental/gcp: build/pre/alma-experimental/gcp
	cd work/alma-experimental/gcp/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-gcp-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/gcp
build/alma-experimental/ovh: build/pre/alma-experimental/ovh
	cd work/alma-experimental/ovh/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-ovh-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/ovh
build/alma-experimental/azure: build/pre/alma-experimental/azure
	cd work/alma-experimental/azure/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-azure-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/azure
build/alma-experimental/linode: build/pre/alma-experimental/linode
	cd work/alma-experimental/linode/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-alma-experimental-linode-${COMMIT_SHORT}" rpm-pkg
	$(MAKE) build/post/alma-experimental/linode

build/amazonlinux-experimental/aws: build/pre/amazonlinux-experimental/aws
	cd work/amazonlinux-experimental/aws/linux && yes "" | KBUILD_BUILD_TIMESTAMP="" $(MAKE) CC="ccache gcc" LOCALVERSION= EXTRAVERSION="-pvm-host-amazonlinux-experimental-aws-${COMMIT_SHORT}" rpm-pkg
